...
Die [Dinge, die Sie für Ihre MoodleBox benötigen][1], sind im Wesentlichen ein Raspberry Pi 3A+, 3B, 3B+, 4B oder 400, ein geeignetes Netzteil und eine microSD-Karte. [Weitere Infos zur Hardware][1].
