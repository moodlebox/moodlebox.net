...
<div class="downloads row gx-0">
  ...
  <div class="image-info col-sm-9">
    ...
    <div class="image-details">
      Size: <strong>{{< ghrelease user="moodlebox" repo="moodlebox" data="file_size" id=3 >}} MB</strong>
    </div>
    <div class="image-details">
    ...
    <div class="image-download-links">
      <a class="btn dl-zip piwik_download" href="{{< ghrelease user="moodlebox" repo="moodlebox" data="download_link" id=3 >}}"><i class="fa fa-download" aria-hidden="true"></i>Download image</a>
