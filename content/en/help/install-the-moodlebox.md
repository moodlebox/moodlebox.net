...
The [stuff you will need][1] to build your MoodleBox is essentially a Raspberry Pi Model 3A+, 3B, 3B+, 4B or 400 with a power supply and a microSD card. [More information here][1].
