...
Pour une mise à jour à une __version majeure__ de Moodle (3.11, 4.0[^future], 4.1[^future], etc.), tapez les commandes ci-dessus, puis __en plus__ les commandes suivantes, en indiquant la branche adéquate, par exemple `MOODLE_311_STABLE`, `MOODLE_40_STABLE`, `MOODLE_41_STABLE`, etc. :
